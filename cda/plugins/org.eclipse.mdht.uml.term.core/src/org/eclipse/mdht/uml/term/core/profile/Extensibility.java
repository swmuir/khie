 ...
 * @generated
 */
public enum Extensibility implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>NEA</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>NEA</b></em>' literal object isn't clear,
	 ...
	 * @ordered
	 */
	public static final int NEA_VALUE = 0;

	/**
	 * The '<em><b>CEA</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>CEA</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @ordered
	 */
	public static final int CEA_VALUE = 1;
	 ...
	 * @generated
	 */
	public static Extensibility get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Extensibility result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static Extensibility getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Extensibility result = VALUES_ARRAY[i];
