...
public class ContextToValueSetImpl extends EObjectImpl implements ContextToValueSet {
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermPackage.CONTEXT_TO_VALUE_SET__KEY, oldKey, key));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermPackage.CONTEXT_TO_VALUE_SET__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TermPackage.CONTEXT_TO_VALUE_SET__KEY:
				return getKey();
			case TermPackage.CONTEXT_TO_VALUE_SET__VALUE:
				return getValue();
		}
