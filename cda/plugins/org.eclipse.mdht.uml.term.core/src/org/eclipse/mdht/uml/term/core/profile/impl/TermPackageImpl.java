...
public class TermPackageImpl extends EPackageImpl implements TermPackage {
	 ...
	 * @generated
	 */
	public EAttribute getContextToValueSet_Key() {
	 ...
	 * @generated
	 */
	public EAttribute getContextToValueSet_Value() {
	...
	public void createPackageContents() {
		...
		createEAttribute(contextToValueSetEClass, CONTEXT_TO_VALUE_SET__KEY);
		createEAttribute(contextToValueSetEClass, CONTEXT_TO_VALUE_SET__VALUE);
	...
	public void initializePackageContents() {
		...
		initEReference(getValueSetConstraints_Base_Property(), theUMLPackage.getProperty(), null, "base_Property", null, 1, 1, ValueSetConstraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
