...
public class TermPackageImpl extends EPackageImpl implements TermPackage {
	 ...
	 * @generated
	 */
	private EClass contextToValueSetEClass = null;
	 ...
	 * @generated
	 */
	private EClass codedTypeEClass = null;
	 ...
	 * @generated
	 */
	public EReference getValueSetConstraints_Constraints() {
	 ...
	 * @generated
	 */
	public EClass getContextToValueSet() {
		return contextToValueSetEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getContextToValueSet_Context() {
		return (EAttribute)contextToValueSetEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getContextToValueSet_ValueSetName() {
		return (EAttribute)contextToValueSetEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getContextToValueSet_ValueSetURI() {
		return (EAttribute)contextToValueSetEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getContextToValueSet_ValueSetOID() {
		return (EAttribute)contextToValueSetEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getContext_Base_Enumeration() {
	 ...
	 * @generated
	 */
	public EClass getCodedType() {
		return codedTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getCodedType_Base_Classifier() {
		return (EReference)codedTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(valueSetConstraintsEClass, VALUE_SET_CONSTRAINTS__CONSTRAINTS);

		contextToValueSetEClass = createEClass(CONTEXT_TO_VALUE_SET);
		createEAttribute(contextToValueSetEClass, CONTEXT_TO_VALUE_SET__CONTEXT);
		createEAttribute(contextToValueSetEClass, CONTEXT_TO_VALUE_SET__VALUE_SET_NAME);
		createEAttribute(contextToValueSetEClass, CONTEXT_TO_VALUE_SET__VALUE_SET_URI);
		createEAttribute(contextToValueSetEClass, CONTEXT_TO_VALUE_SET__VALUE_SET_OID);
		...
		createEReference(contextEClass, CONTEXT__BASE_ENUMERATION);

		codedTypeEClass = createEClass(CODED_TYPE);
		createEReference(codedTypeEClass, CODED_TYPE__BASE_CLASSIFIER);
	...
	public void initializePackageContents() {
		...
		initEReference(getValueSetConstraints_Base_Property(), theUMLPackage.getNamedElement(), null, "base_Property", null, 1, 1, ValueSetConstraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getContextToValueSet_Context(), theTypesPackage.getString(), "context", null, 1, 1, ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getContextToValueSet_ValueSetName(), theTypesPackage.getString(), "valueSetName", null, 0, 1, ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getContextToValueSet_ValueSetURI(), theTypesPackage.getString(), "valueSetURI", null, 0, 1, ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getContextToValueSet_ValueSetOID(), theTypesPackage.getString(), "valueSetOID", null, 0, 1, ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getContext_Base_Enumeration(), theUMLPackage.getEnumeration(), null, "base_Enumeration", null, 1, 1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(codedTypeEClass, CodedType.class, "CodedType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCodedType_Base_Classifier(), theUMLPackage.getClassifier(), null, "base_Classifier", null, 1, 1, CodedType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
