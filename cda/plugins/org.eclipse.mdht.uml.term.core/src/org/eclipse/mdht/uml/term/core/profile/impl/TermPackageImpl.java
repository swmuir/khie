...
public class TermPackageImpl extends EPackageImpl implements TermPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(
			...
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getValueSetConstraint_Uri(), ecorePackage.getEString(), "uri", null, 0, 1, ValueSetConstraint.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(
			...
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(
			getValueSetVersion_Identifier(), ecorePackage.getEString(), "identifier", null, 0, 1, ValueSetVersion.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(
		...
		initEClass(
			...
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(
			getValueSetConstraints_Base_Property(), theUMLPackage.getNamedElement(), null, "base_Property", null, 1, 1,
			ValueSetConstraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(
			getValueSetConstraints_Constraints(), this.getContextToValueSet(), null, "constraints", null, 0, -1,
			ValueSetConstraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(
			contextToValueSetEClass, ContextToValueSet.class, "ContextToValueSet", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(
			getContextToValueSet_Context(), ecorePackage.getEString(), "context", null, 1, 1, ContextToValueSet.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getContextToValueSet_ValueSetName(), ecorePackage.getEString(), "valueSetName", null, 0, 1,
			ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getContextToValueSet_ValueSetURI(), ecorePackage.getEString(), "valueSetURI", null, 0, 1,
			ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getContextToValueSet_ValueSetOID(), ecorePackage.getEString(), "valueSetOID", null, 0, 1,
			ContextToValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		...
		initEReference(
			...
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getNullValueSetConstraint_Identifier(), ecorePackage.getEString(), "identifier", null, 0, 1,
			NullValueSetConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getNullValueSetConstraint_Name(), ecorePackage.getEString(), "name", null, 0, 1,
			NullValueSetConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getNullValueSetConstraint_Version(), ecorePackage.getEString(), "version", null, 0, 1,
			NullValueSetConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
		...
		initEReference(
			getContext_Base_Enumeration(), theUMLPackage.getEnumeration(), null, "base_Enumeration", null, 1, 1,
			Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(
			codedTypeEClass, CodedType.class, "CodedType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(
			getCodedType_Base_Classifier(), theUMLPackage.getClassifier(), null, "base_Classifier", null, 1, 1,
			CodedType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
