...
public class TermSwitch<T> extends Switch<T> {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Context To Value Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 ...
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Context To Value Set</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseContextToValueSet(ContextToValueSet object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Coded Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 ...
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Coded Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCodedType(CodedType object) {
		return null;
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TermPackage.CONTEXT_TO_VALUE_SET: {
				ContextToValueSet contextToValueSet = (ContextToValueSet) theEObject;
				T result = caseContextToValueSet(contextToValueSet);
				if (result == null) {
					result = defaultCase(theEObject);
				}
				return result;
			...
			case TermPackage.CODED_TYPE: {
				CodedType codedType = (CodedType) theEObject;
				T result = caseCodedType(codedType);
				if (result == null) {
					result = defaultCase(theEObject);
				}
				return result;
