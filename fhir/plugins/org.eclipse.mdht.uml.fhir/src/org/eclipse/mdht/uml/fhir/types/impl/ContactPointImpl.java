 ...
 * @generated
 */
public class ContactPointImpl extends MinimalEObjectImpl.Container implements ContactPoint {
	/**
	...
	protected EClass eStaticClass() {
		return FHIRTypesPackage.Literals.CONTACT_POINT;
	}
	...
	public void setSystem(String newSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FHIRTypesPackage.CONTACT_POINT__SYSTEM, oldSystem, system));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FHIRTypesPackage.CONTACT_POINT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FHIRTypesPackage.CONTACT_POINT__SYSTEM:
				return getSystem();
			case FHIRTypesPackage.CONTACT_POINT__VALUE:
				return getValue();
		}
