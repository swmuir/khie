 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.OperationOutcomeImpl#getIssues <em>Issue</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationOutcomeImpl extends DomainResourceImpl implements OperationOutcome {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.eINSTANCE.getOperationOutcome();
	}
	...
	public EList<OperationOutcomeIssue> getIssues() {
		if (issues == null) {
			issues = new EObjectContainmentEList<OperationOutcomeIssue>(OperationOutcomeIssue.class, this, ResourcesPackage.OPERATION_OUTCOME__ISSUE);
		}
		return issues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcesPackage.OPERATION_OUTCOME__ISSUE:
