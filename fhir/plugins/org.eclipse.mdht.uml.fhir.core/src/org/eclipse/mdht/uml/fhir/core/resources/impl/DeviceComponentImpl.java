...
import org.eclipse.mdht.uml.fhir.core.resources.DeviceComponent;
 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getLastSystemChange <em>Last System Change</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getOperationalStati <em>Operational Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getParameterGroup <em>Parameter Group</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getMeasurementPrinciple <em>Measurement Principle</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getProductionSpecifications <em>Production Specification</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceComponentImpl#getLanguageCode <em>Language Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeviceComponentImpl extends DomainResourceImpl implements DeviceComponent {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.eINSTANCE.getDeviceComponent();
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(CodeableConcept newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__TYPE, oldType, type));
	}
	...
	public Identifier getIdentifier() {
		if (identifier != null && identifier.eIsProxy()) {
			...
			if (identifier != oldIdentifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__IDENTIFIER, oldIdentifier, identifier));
			}
		}
		return identifier;
	}
	...
	public void setIdentifier(Identifier newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public Instant getLastSystemChange() {
		if (lastSystemChange != null && lastSystemChange.eIsProxy()) {
			...
			if (lastSystemChange != oldLastSystemChange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__LAST_SYSTEM_CHANGE, oldLastSystemChange, lastSystemChange));
			}
		}
	...
	public void setLastSystemChange(Instant newLastSystemChange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__LAST_SYSTEM_CHANGE, oldLastSystemChange, lastSystemChange));
	}
	...
	public Device getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Device newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__SOURCE, oldSource, source));
	}
	...
	public DeviceComponent getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(DeviceComponent newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__PARENT, oldParent, parent));
	}
	...
	public EList<CodeableConcept> getOperationalStati() {
		if (operationalStati == null) {
			operationalStati = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, ResourcesPackage.DEVICE_COMPONENT__OPERATIONAL_STATUS);
		}
	...
	public CodeableConcept getParameterGroup() {
		if (parameterGroup != null && parameterGroup.eIsProxy()) {
			...
			if (parameterGroup != oldParameterGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__PARAMETER_GROUP, oldParameterGroup, parameterGroup));
			}
		}
	...
	public void setParameterGroup(CodeableConcept newParameterGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__PARAMETER_GROUP, oldParameterGroup, parameterGroup));
	}
	...
	public Code getMeasurementPrinciple() {
		if (measurementPrinciple != null && measurementPrinciple.eIsProxy()) {
			...
			if (measurementPrinciple != oldMeasurementPrinciple) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__MEASUREMENT_PRINCIPLE, oldMeasurementPrinciple, measurementPrinciple));
			}
		}
	...
	public void setMeasurementPrinciple(Code newMeasurementPrinciple) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__MEASUREMENT_PRINCIPLE, oldMeasurementPrinciple, measurementPrinciple));
	}
	...
	public EList<DeviceComponentProductionSpecification> getProductionSpecifications() {
		if (productionSpecifications == null) {
			productionSpecifications = new EObjectContainmentEList<DeviceComponentProductionSpecification>(DeviceComponentProductionSpecification.class, this, ResourcesPackage.DEVICE_COMPONENT__PRODUCTION_SPECIFICATION);
		}
	...
	public CodeableConcept getLanguageCode() {
		if (languageCode != null && languageCode.eIsProxy()) {
			...
			if (languageCode != oldLanguageCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_COMPONENT__LANGUAGE_CODE, oldLanguageCode, languageCode));
			}
		}
		return languageCode;
	}
	...
	public void setLanguageCode(CodeableConcept newLanguageCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_COMPONENT__LANGUAGE_CODE, oldLanguageCode, languageCode));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcesPackage.DEVICE_COMPONENT__PRODUCTION_SPECIFICATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.DEVICE_COMPONENT__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case ResourcesPackage.DEVICE_COMPONENT__IDENTIFIER:
				if (resolve) return getIdentifier();
				return basicGetIdentifier();
			case ResourcesPackage.DEVICE_COMPONENT__LAST_SYSTEM_CHANGE:
				if (resolve) return getLastSystemChange();
				return basicGetLastSystemChange();
			case ResourcesPackage.DEVICE_COMPONENT__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case ResourcesPackage.DEVICE_COMPONENT__PARENT:
				if (resolve) return getParent();
				return basicGetParent();
			case ResourcesPackage.DEVICE_COMPONENT__OPERATIONAL_STATUS:
				return getOperationalStati();
			case ResourcesPackage.DEVICE_COMPONENT__PARAMETER_GROUP:
				if (resolve) return getParameterGroup();
				return basicGetParameterGroup();
			case ResourcesPackage.DEVICE_COMPONENT__MEASUREMENT_PRINCIPLE:
				if (resolve) return getMeasurementPrinciple();
				return basicGetMeasurementPrinciple();
			case ResourcesPackage.DEVICE_COMPONENT__PRODUCTION_SPECIFICATION:
				return getProductionSpecifications();
			case ResourcesPackage.DEVICE_COMPONENT__LANGUAGE_CODE:
