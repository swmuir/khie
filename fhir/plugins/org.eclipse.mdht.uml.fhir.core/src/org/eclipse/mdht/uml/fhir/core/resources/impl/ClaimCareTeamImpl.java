 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimCareTeamImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimCareTeamImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimCareTeamImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimCareTeamImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimCareTeamImpl#getQualification <em>Qualification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClaimCareTeamImpl extends BackboneElementImpl implements ClaimCareTeam {
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_CARE_TEAM__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_CARE_TEAM__SEQUENCE, oldSequence, sequence));
	}
	...
	public Resource getProvider() {
		if (provider != null && provider.eIsProxy()) {
			...
			if (provider != oldProvider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_CARE_TEAM__PROVIDER, oldProvider, provider));
			}
		}
		return provider;
	}
	...
	public void setProvider(Resource newProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_CARE_TEAM__PROVIDER, oldProvider, provider));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.Boolean getResponsible() {
		if (responsible != null && responsible.eIsProxy()) {
			...
			if (responsible != oldResponsible) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_CARE_TEAM__RESPONSIBLE, oldResponsible, responsible));
			}
		}
		return responsible;
	}
	...
	public void setResponsible(org.eclipse.mdht.uml.fhir.core.dataTypes.Boolean newResponsible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_CARE_TEAM__RESPONSIBLE, oldResponsible, responsible));
	}
	...
	public CodeableConcept getRole() {
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_CARE_TEAM__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	public void setRole(CodeableConcept newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_CARE_TEAM__ROLE, oldRole, role));
	}
	...
	public CodeableConcept getQualification() {
		if (qualification != null && qualification.eIsProxy()) {
			...
			if (qualification != oldQualification) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_CARE_TEAM__QUALIFICATION, oldQualification, qualification));
			}
		}
	...
	public void setQualification(CodeableConcept newQualification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_CARE_TEAM__QUALIFICATION, oldQualification, qualification));
	}
