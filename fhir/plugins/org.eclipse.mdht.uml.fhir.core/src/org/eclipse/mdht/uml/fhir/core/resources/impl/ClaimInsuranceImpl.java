 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimInsuranceImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimInsuranceImpl#getFocal <em>Focal</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimInsuranceImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimInsuranceImpl#getBusinessArrangement <em>Business Arrangement</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimInsuranceImpl#getPreAuthRefs <em>Pre Auth Ref</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimInsuranceImpl#getClaimResponse <em>Claim Response</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClaimInsuranceImpl extends BackboneElementImpl implements ClaimInsurance {
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_INSURANCE__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_INSURANCE__SEQUENCE, oldSequence, sequence));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.Boolean getFocal() {
		if (focal != null && focal.eIsProxy()) {
			...
			if (focal != oldFocal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_INSURANCE__FOCAL, oldFocal, focal));
			}
		}
		return focal;
	}
	...
	public void setFocal(org.eclipse.mdht.uml.fhir.core.dataTypes.Boolean newFocal) {
		...
		focal = newFocal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_INSURANCE__FOCAL, oldFocal, focal));
	}
	...
	public Coverage getCoverage() {
		if (coverage != null && coverage.eIsProxy()) {
			...
			if (coverage != oldCoverage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_INSURANCE__COVERAGE, oldCoverage, coverage));
			}
		}
		return coverage;
	}
	...
	public void setCoverage(Coverage newCoverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_INSURANCE__COVERAGE, oldCoverage, coverage));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getBusinessArrangement() {
		if (businessArrangement != null && businessArrangement.eIsProxy()) {
			...
			if (businessArrangement != oldBusinessArrangement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_INSURANCE__BUSINESS_ARRANGEMENT, oldBusinessArrangement, businessArrangement));
			}
		}
	...
	public void setBusinessArrangement(org.eclipse.mdht.uml.fhir.core.dataTypes.String newBusinessArrangement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_INSURANCE__BUSINESS_ARRANGEMENT, oldBusinessArrangement, businessArrangement));
	}
	...
	public EList<org.eclipse.mdht.uml.fhir.core.dataTypes.String> getPreAuthRefs() {
		if (preAuthRefs == null) {
			preAuthRefs = new EObjectResolvingEList<org.eclipse.mdht.uml.fhir.core.dataTypes.String>(org.eclipse.mdht.uml.fhir.core.dataTypes.String.class, this, ResourcesPackage.CLAIM_INSURANCE__PRE_AUTH_REF);
		}
		return preAuthRefs;
	}
	...
	public ClaimResponse getClaimResponse() {
		if (claimResponse != null && claimResponse.eIsProxy()) {
			...
			if (claimResponse != oldClaimResponse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_INSURANCE__CLAIM_RESPONSE, oldClaimResponse, claimResponse));
			}
		}
	...
	public void setClaimResponse(ClaimResponse newClaimResponse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_INSURANCE__CLAIM_RESPONSE, oldClaimResponse, claimResponse));
	}
