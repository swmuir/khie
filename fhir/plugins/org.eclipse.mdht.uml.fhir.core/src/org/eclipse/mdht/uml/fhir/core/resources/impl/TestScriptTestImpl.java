 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.TestScriptTestImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.TestScriptTestImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.TestScriptTestImpl#getActions <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestScriptTestImpl extends BackboneElementImpl implements TestScriptTest {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.eINSTANCE.getTestScriptTest();
	}
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.TEST_SCRIPT_TEST__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(org.eclipse.mdht.uml.fhir.core.dataTypes.String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.TEST_SCRIPT_TEST__NAME, oldName, name));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.TEST_SCRIPT_TEST__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(org.eclipse.mdht.uml.fhir.core.dataTypes.String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.TEST_SCRIPT_TEST__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<TestScriptTestTestAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<TestScriptTestTestAction>(TestScriptTestTestAction.class, this, ResourcesPackage.TEST_SCRIPT_TEST__ACTION);
		}
		return actions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcesPackage.TEST_SCRIPT_TEST__ACTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.TEST_SCRIPT_TEST__NAME:
				if (resolve) return getName();
				return basicGetName();
			case ResourcesPackage.TEST_SCRIPT_TEST__DESCRIPTION:
