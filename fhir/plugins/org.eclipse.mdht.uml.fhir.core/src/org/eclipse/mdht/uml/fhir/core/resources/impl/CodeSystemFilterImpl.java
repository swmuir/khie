 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CodeSystemFilterImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CodeSystemFilterImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CodeSystemFilterImpl#getOperators <em>Operator</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CodeSystemFilterImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CodeSystemFilterImpl extends BackboneElementImpl implements CodeSystemFilter {
	...
	/**
	 * The cached value of the '{@link #getOperators() <em>Operator</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOperators()
	 * @generated
		...
		if (code != null && code.eIsProxy()) {
			...
			if (code != oldCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CODE_SYSTEM_FILTER__CODE, oldCode, code));
			}
		}
		return code;
	}
	...
	public void setCode(Code newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CODE_SYSTEM_FILTER__CODE, oldCode, code));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CODE_SYSTEM_FILTER__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(org.eclipse.mdht.uml.fhir.core.dataTypes.String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CODE_SYSTEM_FILTER__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Code> getOperators() {
		if (operators == null) {
			operators = new EObjectResolvingEList<Code>(Code.class, this, ResourcesPackage.CODE_SYSTEM_FILTER__OPERATOR);
		}
		return operators;
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CODE_SYSTEM_FILTER__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(org.eclipse.mdht.uml.fhir.core.dataTypes.String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CODE_SYSTEM_FILTER__VALUE, oldValue, value));
	}
