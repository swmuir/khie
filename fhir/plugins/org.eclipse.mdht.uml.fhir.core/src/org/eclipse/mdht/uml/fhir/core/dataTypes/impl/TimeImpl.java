 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.dataTypes.impl.TimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimeImpl extends DataTypeImpl implements Time {
	/**
	...
	protected EClass eStaticClass() {
		return DataTypesPackage.Literals.TIME;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataTypesPackage.TIME__VALUE:
				return getValue();
		}
