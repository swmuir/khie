 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.dataTypes.impl.Base64BinaryImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Base64BinaryImpl extends DataTypeImpl implements Base64Binary {
	...
	protected EClass eStaticClass() {
		return DataTypesPackage.Literals.BASE64_BINARY;
	}
	...
	public void setValue(byte[] newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.BASE64_BINARY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataTypesPackage.BASE64_BINARY__VALUE:
				return getValue();
		}
