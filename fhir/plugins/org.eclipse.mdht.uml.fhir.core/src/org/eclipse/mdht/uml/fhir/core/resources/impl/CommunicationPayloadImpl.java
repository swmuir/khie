 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CommunicationPayloadImpl#getContentx <em>Contentx</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommunicationPayloadImpl extends BackboneElementImpl implements CommunicationPayload {
		...
		if (contentx != null && contentx.eIsProxy()) {
			...
			if (contentx != oldContentx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.COMMUNICATION_PAYLOAD__CONTENTX, oldContentx, contentx));
			}
		}
		return contentx;
	}
	...
	public void setContentx(Base newContentx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.COMMUNICATION_PAYLOAD__CONTENTX, oldContentx, contentx));
	}
