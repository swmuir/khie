 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.dataTypes.impl.ContactDetailImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.dataTypes.impl.ContactDetailImpl#getTelecoms <em>Telecom</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContactDetailImpl extends DataTypeImpl implements ContactDetail {
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataTypesPackage.CONTACT_DETAIL__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(org.eclipse.mdht.uml.fhir.core.dataTypes.String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.CONTACT_DETAIL__NAME, oldName, name));
	}
	...
	public EList<ContactPoint> getTelecoms() {
		if (telecoms == null) {
			telecoms = new EObjectResolvingEList<ContactPoint>(ContactPoint.class, this, DataTypesPackage.CONTACT_DETAIL__TELECOM);
		}
		return telecoms;
	}
