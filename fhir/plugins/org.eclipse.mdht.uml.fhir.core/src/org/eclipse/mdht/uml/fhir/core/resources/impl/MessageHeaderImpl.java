...
import org.eclipse.mdht.uml.fhir.core.resources.MessageHeader;
 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getDestinations <em>Destination</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getReceiver <em>Receiver</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MessageHeaderImpl#getData <em>Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageHeaderImpl extends DomainResourceImpl implements MessageHeader {
		...
		if (timestamp != null && timestamp.eIsProxy()) {
			...
			if (timestamp != oldTimestamp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__TIMESTAMP, oldTimestamp, timestamp));
			}
		}
		return timestamp;
	}
	...
	public void setTimestamp(Instant newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__TIMESTAMP, oldTimestamp, timestamp));
	}
	...
	public Coding getEvent() {
		if (event != null && event.eIsProxy()) {
			...
			if (event != oldEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__EVENT, oldEvent, event));
			}
		}
		return event;
	}
	...
	public void setEvent(Coding newEvent) {
		...
		event = newEvent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__EVENT, oldEvent, event));
	}
	...
	public Practitioner getEnterer() {
		if (enterer != null && enterer.eIsProxy()) {
			...
			if (enterer != oldEnterer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__ENTERER, oldEnterer, enterer));
			}
		}
		return enterer;
	}
	...
	public void setEnterer(Practitioner newEnterer) {
		...
		enterer = newEnterer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__ENTERER, oldEnterer, enterer));
	}
	...
	public Practitioner getAuthor() {
		if (author != null && author.eIsProxy()) {
			...
			if (author != oldAuthor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__AUTHOR, oldAuthor, author));
			}
		}
		return author;
	}
	...
	public void setAuthor(Practitioner newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__AUTHOR, oldAuthor, author));
	}
	...
	public Resource getReceiver() {
		if (receiver != null && receiver.eIsProxy()) {
			...
			if (receiver != oldReceiver) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__RECEIVER, oldReceiver, receiver));
			}
		}
		return receiver;
	}
	...
	public void setReceiver(Resource newReceiver) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__RECEIVER, oldReceiver, receiver));
	}
	...
	public Resource getResponsible() {
		if (responsible != null && responsible.eIsProxy()) {
			...
			if (responsible != oldResponsible) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__RESPONSIBLE, oldResponsible, responsible));
			}
		}
		return responsible;
	}
	...
	public void setResponsible(Resource newResponsible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__RESPONSIBLE, oldResponsible, responsible));
	}
	...
	public CodeableConcept getReason() {
		if (reason != null && reason.eIsProxy()) {
			...
			if (reason != oldReason) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MESSAGE_HEADER__REASON, oldReason, reason));
			}
		}
		return reason;
	}
	...
	public void setReason(CodeableConcept newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MESSAGE_HEADER__REASON, oldReason, reason));
	}
	...
	public EList<Resource> getData() {
		if (data == null) {
			data = new EObjectResolvingEList<Resource>(Resource.class, this, ResourcesPackage.MESSAGE_HEADER__DATA);
		}
		return data;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.MESSAGE_HEADER__TIMESTAMP:
				if (resolve) return getTimestamp();
				return basicGetTimestamp();
			case ResourcesPackage.MESSAGE_HEADER__EVENT:
			...
			case ResourcesPackage.MESSAGE_HEADER__RECEIVER:
			...
			case ResourcesPackage.MESSAGE_HEADER__DATA:
				return getData();
		}
