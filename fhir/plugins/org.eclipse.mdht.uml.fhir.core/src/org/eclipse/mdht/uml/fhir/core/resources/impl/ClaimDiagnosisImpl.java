 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimDiagnosisImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimDiagnosisImpl#getDiagnosisx <em>Diagnosisx</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimDiagnosisImpl#getTypes <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimDiagnosisImpl#getPackageCode <em>Package Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClaimDiagnosisImpl extends BackboneElementImpl implements ClaimDiagnosis {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.eINSTANCE.getClaimDiagnosis();
	}
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_DIAGNOSIS__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_DIAGNOSIS__SEQUENCE, oldSequence, sequence));
	}
	...
	public Base getDiagnosisx() {
		if (diagnosisx != null && diagnosisx.eIsProxy()) {
			...
			if (diagnosisx != oldDiagnosisx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_DIAGNOSIS__DIAGNOSISX, oldDiagnosisx, diagnosisx));
			}
		}
		return diagnosisx;
	}
	...
	public void setDiagnosisx(Base newDiagnosisx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_DIAGNOSIS__DIAGNOSISX, oldDiagnosisx, diagnosisx));
	}
	...
	public EList<CodeableConcept> getTypes() {
		if (types == null) {
			types = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, ResourcesPackage.CLAIM_DIAGNOSIS__TYPE);
		}
		return types;
	}
	...
	public CodeableConcept getPackageCode() {
		if (packageCode != null && packageCode.eIsProxy()) {
			...
			if (packageCode != oldPackageCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_DIAGNOSIS__PACKAGE_CODE, oldPackageCode, packageCode));
			}
		}
		return packageCode;
	}
	...
	public void setPackageCode(CodeableConcept newPackageCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_DIAGNOSIS__PACKAGE_CODE, oldPackageCode, packageCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.CLAIM_DIAGNOSIS__SEQUENCE:
				if (resolve) return getSequence();
				return basicGetSequence();
			case ResourcesPackage.CLAIM_DIAGNOSIS__DIAGNOSISX:
				if (resolve) return getDiagnosisx();
				return basicGetDiagnosisx();
			case ResourcesPackage.CLAIM_DIAGNOSIS__TYPE:
				return getTypes();
			case ResourcesPackage.CLAIM_DIAGNOSIS__PACKAGE_CODE:
