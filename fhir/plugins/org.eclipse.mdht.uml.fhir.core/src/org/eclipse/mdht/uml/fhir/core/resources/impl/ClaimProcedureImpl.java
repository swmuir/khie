 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimProcedureImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimProcedureImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimProcedureImpl#getProcedurex <em>Procedurex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClaimProcedureImpl extends BackboneElementImpl implements ClaimProcedure {
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_PROCEDURE__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_PROCEDURE__SEQUENCE, oldSequence, sequence));
	}
	...
	public DateTime getDate() {
		if (date != null && date.eIsProxy()) {
			...
			if (date != oldDate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_PROCEDURE__DATE, oldDate, date));
			}
		}
		return date;
	}
	...
	public void setDate(DateTime newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_PROCEDURE__DATE, oldDate, date));
	}
	...
	public Base getProcedurex() {
		if (procedurex != null && procedurex.eIsProxy()) {
			...
			if (procedurex != oldProcedurex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_PROCEDURE__PROCEDUREX, oldProcedurex, procedurex));
			}
		}
		return procedurex;
	}
	...
	public void setProcedurex(Base newProcedurex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_PROCEDURE__PROCEDUREX, oldProcedurex, procedurex));
	}
