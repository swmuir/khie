 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MeasureReportGroupStratifierStratifierGroupStratifierGroupPopulationImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MeasureReportGroupStratifierStratifierGroupStratifierGroupPopulationImpl#getCount <em>Count</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.MeasureReportGroupStratifierStratifierGroupStratifierGroupPopulationImpl#getPatients <em>Patients</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasureReportGroupStratifierStratifierGroupStratifierGroupPopulationImpl extends BackboneElementImpl implements MeasureReportGroupStratifierStratifierGroupStratifierGroupPopulation {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Code newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__TYPE, oldType, type));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.Integer getCount() {
		if (count != null && count.eIsProxy()) {
			...
			if (count != oldCount) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__COUNT, oldCount, count));
			}
		}
		return count;
	}
	...
	public void setCount(org.eclipse.mdht.uml.fhir.core.dataTypes.Integer newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__COUNT, oldCount, count));
	}
	...
	public List getPatients() {
		if (patients != null && patients.eIsProxy()) {
			...
			if (patients != oldPatients) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__PATIENTS, oldPatients, patients));
			}
		}
		return patients;
	}
	...
	public void setPatients(List newPatients) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__PATIENTS, oldPatients, patients));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__TYPE:
			...
			case ResourcesPackage.MEASURE_REPORT_GROUP_STRATIFIER_STRATIFIER_GROUP_STRATIFIER_GROUP_POPULATION__PATIENTS:
