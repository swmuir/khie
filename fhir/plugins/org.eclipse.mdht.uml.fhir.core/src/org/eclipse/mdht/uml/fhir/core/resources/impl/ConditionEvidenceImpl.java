 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ConditionEvidenceImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ConditionEvidenceImpl#getDetails <em>Detail</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionEvidenceImpl extends BackboneElementImpl implements ConditionEvidence {
		...
		if (code != null && code.eIsProxy()) {
			...
			if (code != oldCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CONDITION_EVIDENCE__CODE, oldCode, code));
			}
		}
		return code;
	}
	...
	public void setCode(CodeableConcept newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CONDITION_EVIDENCE__CODE, oldCode, code));
	}
	...
	public EList<Resource> getDetails() {
		if (details == null) {
			details = new EObjectResolvingEList<Resource>(Resource.class, this, ResourcesPackage.CONDITION_EVIDENCE__DETAIL);
		}
		return details;
	}
