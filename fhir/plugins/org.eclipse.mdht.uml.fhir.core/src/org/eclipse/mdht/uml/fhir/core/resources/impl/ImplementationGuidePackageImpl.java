 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ImplementationGuidePackageImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ImplementationGuidePackageImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ImplementationGuidePackageImpl#getResources <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImplementationGuidePackageImpl extends BackboneElementImpl implements ImplementationGuidePackage {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.eINSTANCE.getImplementationGuidePackage();
	}
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(org.eclipse.mdht.uml.fhir.core.dataTypes.String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__NAME, oldName, name));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(org.eclipse.mdht.uml.fhir.core.dataTypes.String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<ImplementationGuidePackageResource> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<ImplementationGuidePackageResource>(ImplementationGuidePackageResource.class, this, ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__RESOURCE);
		}
		return resources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__RESOURCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__NAME:
				if (resolve) return getName();
				return basicGetName();
			case ResourcesPackage.IMPLEMENTATION_GUIDE_PACKAGE__DESCRIPTION:
