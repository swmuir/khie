 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getService <em>Service</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getProgramCodes <em>Program Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getNet <em>Net</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimItemDetailSubDetailImpl#getUdis <em>Udi</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClaimItemDetailSubDetailImpl extends BackboneElementImpl implements ClaimItemDetailSubDetail {
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__SEQUENCE, oldSequence, sequence));
	}
	...
	public CodeableConcept getRevenue() {
		if (revenue != null && revenue.eIsProxy()) {
			...
			if (revenue != oldRevenue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__REVENUE, oldRevenue, revenue));
			}
		}
		return revenue;
	}
	...
	public void setRevenue(CodeableConcept newRevenue) {
		...
		revenue = newRevenue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__REVENUE, oldRevenue, revenue));
	}
	...
	public CodeableConcept getCategory() {
		if (category != null && category.eIsProxy()) {
			...
			if (category != oldCategory) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__CATEGORY, oldCategory, category));
			}
		}
		return category;
	}
	...
	public void setCategory(CodeableConcept newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__CATEGORY, oldCategory, category));
	}
	...
	public CodeableConcept getService() {
		if (service != null && service.eIsProxy()) {
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__SERVICE, oldService, service));
			}
		}
		return service;
	}
	...
	public void setService(CodeableConcept newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__SERVICE, oldService, service));
	}
	...
	public EList<CodeableConcept> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__MODIFIER);
		}
		return modifiers;
	}
	...
	public EList<CodeableConcept> getProgramCodes() {
		if (programCodes == null) {
			programCodes = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__PROGRAM_CODE);
		}
		return programCodes;
	}
	...
	public SimpleQuantity getQuantity() {
		if (quantity != null && quantity.eIsProxy()) {
			...
			if (quantity != oldQuantity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__QUANTITY, oldQuantity, quantity));
			}
		}
		return quantity;
	}
	...
	public void setQuantity(SimpleQuantity newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__QUANTITY, oldQuantity, quantity));
	}
	...
	public Money getUnitPrice() {
		if (unitPrice != null && unitPrice.eIsProxy()) {
			...
			if (unitPrice != oldUnitPrice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__UNIT_PRICE, oldUnitPrice, unitPrice));
			}
		}
		return unitPrice;
	}
	...
	public void setUnitPrice(Money newUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__UNIT_PRICE, oldUnitPrice, unitPrice));
	}
	...
	public Decimal getFactor() {
		if (factor != null && factor.eIsProxy()) {
			...
			if (factor != oldFactor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__FACTOR, oldFactor, factor));
			}
		}
		return factor;
	}
	...
	public void setFactor(Decimal newFactor) {
		...
		factor = newFactor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__FACTOR, oldFactor, factor));
	}
	...
	public Money getNet() {
		if (net != null && net.eIsProxy()) {
			...
			if (net != oldNet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__NET, oldNet, net));
			}
		}
		return net;
	}
	...
	public void setNet(Money newNet) {
		...
		net = newNet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__NET, oldNet, net));
	}
	...
	public EList<Device> getUdis() {
		if (udis == null) {
			udis = new EObjectResolvingEList<Device>(Device.class, this, ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__UDI);
		}
		return udis;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ResourcesPackage.CLAIM_ITEM_DETAIL_SUB_DETAIL__SERVICE:
