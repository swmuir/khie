 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ContractFriendlyLanguageImpl#getContentx <em>Contentx</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContractFriendlyLanguageImpl extends BackboneElementImpl implements ContractFriendlyLanguage {
		...
		if (contentx != null && contentx.eIsProxy()) {
			...
			if (contentx != oldContentx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CONTRACT_FRIENDLY_LANGUAGE__CONTENTX, oldContentx, contentx));
			}
		}
		return contentx;
	}
	...
	public void setContentx(Base newContentx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CONTRACT_FRIENDLY_LANGUAGE__CONTENTX, oldContentx, contentx));
	}
