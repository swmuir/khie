 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CapabilityStatementRestResourceResourceInteractionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.CapabilityStatementRestResourceResourceInteractionImpl#getDocumentation <em>Documentation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CapabilityStatementRestResourceResourceInteractionImpl extends BackboneElementImpl implements CapabilityStatementRestResourceResourceInteraction {
		...
		if (code != null && code.eIsProxy()) {
			...
			if (code != oldCode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CAPABILITY_STATEMENT_REST_RESOURCE_RESOURCE_INTERACTION__CODE, oldCode, code));
			}
		}
		return code;
	}
	...
	public void setCode(Code newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CAPABILITY_STATEMENT_REST_RESOURCE_RESOURCE_INTERACTION__CODE, oldCode, code));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getDocumentation() {
		if (documentation != null && documentation.eIsProxy()) {
			...
			if (documentation != oldDocumentation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CAPABILITY_STATEMENT_REST_RESOURCE_RESOURCE_INTERACTION__DOCUMENTATION, oldDocumentation, documentation));
			}
		}
	...
	public void setDocumentation(org.eclipse.mdht.uml.fhir.core.dataTypes.String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CAPABILITY_STATEMENT_REST_RESOURCE_RESOURCE_INTERACTION__DOCUMENTATION, oldDocumentation, documentation));
	}
