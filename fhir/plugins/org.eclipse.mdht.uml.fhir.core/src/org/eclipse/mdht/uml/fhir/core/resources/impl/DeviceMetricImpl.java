...
import org.eclipse.mdht.uml.fhir.core.resources.DeviceMetric;
 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getOperationalStatus <em>Operational Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getMeasurementPeriod <em>Measurement Period</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DeviceMetricImpl#getCalibrations <em>Calibration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeviceMetricImpl extends DomainResourceImpl implements DeviceMetric {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(CodeableConcept newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__TYPE, oldType, type));
	}
	...
	public Identifier getIdentifier() {
		if (identifier != null && identifier.eIsProxy()) {
			...
			if (identifier != oldIdentifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__IDENTIFIER, oldIdentifier, identifier));
			}
		}
		return identifier;
	}
	...
	public void setIdentifier(Identifier newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public CodeableConcept getUnit() {
		if (unit != null && unit.eIsProxy()) {
			...
			if (unit != oldUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__UNIT, oldUnit, unit));
			}
		}
		return unit;
	}
	...
	public void setUnit(CodeableConcept newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__UNIT, oldUnit, unit));
	}
	...
	public Device getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Device newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__SOURCE, oldSource, source));
	}
	...
	public DeviceComponent getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(DeviceComponent newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__PARENT, oldParent, parent));
	}
	...
	public Code getOperationalStatus() {
		if (operationalStatus != null && operationalStatus.eIsProxy()) {
			...
			if (operationalStatus != oldOperationalStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__OPERATIONAL_STATUS, oldOperationalStatus, operationalStatus));
			}
		}
	...
	public void setOperationalStatus(Code newOperationalStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__OPERATIONAL_STATUS, oldOperationalStatus, operationalStatus));
	}
	...
	public Code getColor() {
		if (color != null && color.eIsProxy()) {
			...
			if (color != oldColor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__COLOR, oldColor, color));
			}
		}
		return color;
	}
	...
	public void setColor(Code newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__COLOR, oldColor, color));
	}
	...
	public Code getCategory() {
		if (category != null && category.eIsProxy()) {
			...
			if (category != oldCategory) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__CATEGORY, oldCategory, category));
			}
		}
		return category;
	}
	...
	public void setCategory(Code newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__CATEGORY, oldCategory, category));
	}
	...
	public Timing getMeasurementPeriod() {
		if (measurementPeriod != null && measurementPeriod.eIsProxy()) {
			...
			if (measurementPeriod != oldMeasurementPeriod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DEVICE_METRIC__MEASUREMENT_PERIOD, oldMeasurementPeriod, measurementPeriod));
			}
		}
	...
	public void setMeasurementPeriod(Timing newMeasurementPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DEVICE_METRIC__MEASUREMENT_PERIOD, oldMeasurementPeriod, measurementPeriod));
	}
