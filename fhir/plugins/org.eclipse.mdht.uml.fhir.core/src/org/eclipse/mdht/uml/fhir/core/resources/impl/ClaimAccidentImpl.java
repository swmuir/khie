 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimAccidentImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimAccidentImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ClaimAccidentImpl#getLocationx <em>Locationx</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClaimAccidentImpl extends BackboneElementImpl implements ClaimAccident {
		...
		if (date != null && date.eIsProxy()) {
			...
			if (date != oldDate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ACCIDENT__DATE, oldDate, date));
			}
		}
		return date;
	}
	...
	public void setDate(Date newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ACCIDENT__DATE, oldDate, date));
	}
	...
	public CodeableConcept getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ACCIDENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(CodeableConcept newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ACCIDENT__TYPE, oldType, type));
	}
	...
	public Base getLocationx() {
		if (locationx != null && locationx.eIsProxy()) {
			...
			if (locationx != oldLocationx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.CLAIM_ACCIDENT__LOCATIONX, oldLocationx, locationx));
			}
		}
		return locationx;
	}
	...
	public void setLocationx(Base newLocationx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CLAIM_ACCIDENT__LOCATIONX, oldLocationx, locationx));
	}
