 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.PractitionerRoleNotAvailableImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.PractitionerRoleNotAvailableImpl#getDuring <em>During</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PractitionerRoleNotAvailableImpl extends BackboneElementImpl implements PractitionerRoleNotAvailable {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.eINSTANCE.getPractitionerRoleNotAvailable();
	}
		...
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.PRACTITIONER_ROLE_NOT_AVAILABLE__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(org.eclipse.mdht.uml.fhir.core.dataTypes.String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.PRACTITIONER_ROLE_NOT_AVAILABLE__DESCRIPTION, oldDescription, description));
	}
	...
	public Period getDuring() {
		if (during != null && during.eIsProxy()) {
			...
			if (during != oldDuring) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.PRACTITIONER_ROLE_NOT_AVAILABLE__DURING, oldDuring, during));
			}
		}
		return during;
	}
	...
	public void setDuring(Period newDuring) {
		...
		during = newDuring;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.PRACTITIONER_ROLE_NOT_AVAILABLE__DURING, oldDuring, during));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.PRACTITIONER_ROLE_NOT_AVAILABLE__DESCRIPTION:
				if (resolve) return getDescription();
				return basicGetDescription();
			case ResourcesPackage.PRACTITIONER_ROLE_NOT_AVAILABLE__DURING:
