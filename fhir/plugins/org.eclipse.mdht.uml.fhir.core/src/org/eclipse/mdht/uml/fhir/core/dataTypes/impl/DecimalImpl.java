 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.dataTypes.impl.DecimalImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecimalImpl extends DataTypeImpl implements Decimal {
	...
	protected EClass eStaticClass() {
		return DataTypesPackage.Literals.DECIMAL;
	}
	...
	public void setValue(BigDecimal newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.DECIMAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataTypesPackage.DECIMAL__VALUE:
				return getValue();
		}
