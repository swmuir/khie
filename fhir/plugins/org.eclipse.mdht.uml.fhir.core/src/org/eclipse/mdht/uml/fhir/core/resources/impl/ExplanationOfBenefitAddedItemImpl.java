 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getSequenceLinkIds <em>Sequence Link Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getService <em>Service</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getFee <em>Fee</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getNoteNumbers <em>Note Number</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getAdjudications <em>Adjudication</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ExplanationOfBenefitAddedItemImpl#getDetails <em>Detail</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExplanationOfBenefitAddedItemImpl extends BackboneElementImpl implements ExplanationOfBenefitAddedItem {
	...
	public EList<PositiveInt> getSequenceLinkIds() {
		if (sequenceLinkIds == null) {
			sequenceLinkIds = new EObjectResolvingEList<PositiveInt>(PositiveInt.class, this, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__SEQUENCE_LINK_ID);
		}
		...
		if (revenue != null && revenue.eIsProxy()) {
			...
			if (revenue != oldRevenue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__REVENUE, oldRevenue, revenue));
			}
		}
		return revenue;
	}
	...
	public void setRevenue(CodeableConcept newRevenue) {
		...
		revenue = newRevenue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__REVENUE, oldRevenue, revenue));
	}
	...
	public CodeableConcept getCategory() {
		if (category != null && category.eIsProxy()) {
			...
			if (category != oldCategory) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__CATEGORY, oldCategory, category));
			}
		}
		return category;
	}
	...
	public void setCategory(CodeableConcept newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__CATEGORY, oldCategory, category));
	}
	...
	public CodeableConcept getService() {
		if (service != null && service.eIsProxy()) {
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__SERVICE, oldService, service));
			}
		}
		return service;
	}
	...
	public void setService(CodeableConcept newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__SERVICE, oldService, service));
	}
	...
	public EList<CodeableConcept> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__MODIFIER);
		}
		return modifiers;
	}
	...
	public Money getFee() {
		if (fee != null && fee.eIsProxy()) {
			...
			if (fee != oldFee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__FEE, oldFee, fee));
			}
		}
		return fee;
	}
	...
	public void setFee(Money newFee) {
		...
		fee = newFee;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__FEE, oldFee, fee));
	}
	...
	public EList<PositiveInt> getNoteNumbers() {
		if (noteNumbers == null) {
			noteNumbers = new EObjectResolvingEList<PositiveInt>(PositiveInt.class, this, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__NOTE_NUMBER);
		}
		return noteNumbers;
	}
	...
	public EList<ExplanationOfBenefitAddedItemAddedItemsDetail> getDetails() {
		if (details == null) {
			details = new EObjectContainmentEList<ExplanationOfBenefitAddedItemAddedItemsDetail>(ExplanationOfBenefitAddedItemAddedItemsDetail.class, this, ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__DETAIL);
		}
		return details;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__SEQUENCE_LINK_ID:
				return getSequenceLinkIds();
			case ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__REVENUE:
				if (resolve) return getRevenue();
				return basicGetRevenue();
			case ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__CATEGORY:
				if (resolve) return getCategory();
				return basicGetCategory();
			case ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__SERVICE:
				if (resolve) return getService();
				return basicGetService();
			case ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__MODIFIER:
				return getModifiers();
			case ResourcesPackage.EXPLANATION_OF_BENEFIT_ADDED_ITEM__FEE:
