 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.PractitionerRoleAvailableTimeImpl#getDaysOfWeeks <em>Days Of Week</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.PractitionerRoleAvailableTimeImpl#getAllDay <em>All Day</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.PractitionerRoleAvailableTimeImpl#getAvailableStartTime <em>Available Start Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.PractitionerRoleAvailableTimeImpl#getAvailableEndTime <em>Available End Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PractitionerRoleAvailableTimeImpl extends BackboneElementImpl implements PractitionerRoleAvailableTime {
	...
	public EList<Code> getDaysOfWeeks() {
		if (daysOfWeeks == null) {
			daysOfWeeks = new EObjectResolvingEList<Code>(Code.class, this, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__DAYS_OF_WEEK);
		}
		return daysOfWeeks;
	}
		...
		if (allDay != null && allDay.eIsProxy()) {
			...
			if (allDay != oldAllDay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__ALL_DAY, oldAllDay, allDay));
			}
		}
		return allDay;
	}
	...
	public void setAllDay(org.eclipse.mdht.uml.fhir.core.dataTypes.Boolean newAllDay) {
		...
		allDay = newAllDay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__ALL_DAY, oldAllDay, allDay));
	}
	...
	public Time getAvailableStartTime() {
		if (availableStartTime != null && availableStartTime.eIsProxy()) {
			...
			if (availableStartTime != oldAvailableStartTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME, oldAvailableStartTime, availableStartTime));
			}
		}
	...
	public void setAvailableStartTime(Time newAvailableStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME, oldAvailableStartTime, availableStartTime));
	}
	...
	public Time getAvailableEndTime() {
		if (availableEndTime != null && availableEndTime.eIsProxy()) {
			...
			if (availableEndTime != oldAvailableEndTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME, oldAvailableEndTime, availableEndTime));
			}
		}
	...
	public void setAvailableEndTime(Time newAvailableEndTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME, oldAvailableEndTime, availableEndTime));
	}
