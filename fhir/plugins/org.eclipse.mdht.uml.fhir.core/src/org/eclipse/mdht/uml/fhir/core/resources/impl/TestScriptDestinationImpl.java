 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.TestScriptDestinationImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.TestScriptDestinationImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestScriptDestinationImpl extends BackboneElementImpl implements TestScriptDestination {
		...
		if (index != null && index.eIsProxy()) {
			...
			if (index != oldIndex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.TEST_SCRIPT_DESTINATION__INDEX, oldIndex, index));
			}
		}
		return index;
	}
	...
	public void setIndex(org.eclipse.mdht.uml.fhir.core.dataTypes.Integer newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.TEST_SCRIPT_DESTINATION__INDEX, oldIndex, index));
	}
	...
	public Coding getProfile() {
		if (profile != null && profile.eIsProxy()) {
			...
			if (profile != oldProfile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.TEST_SCRIPT_DESTINATION__PROFILE, oldProfile, profile));
			}
		}
		return profile;
	}
	...
	public void setProfile(Coding newProfile) {
		...
		profile = newProfile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.TEST_SCRIPT_DESTINATION__PROFILE, oldProfile, profile));
	}
