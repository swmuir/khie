 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ActivityDefinitionDynamicValueImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ActivityDefinitionDynamicValueImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ActivityDefinitionDynamicValueImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.ActivityDefinitionDynamicValueImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityDefinitionDynamicValueImpl extends BackboneElementImpl implements ActivityDefinitionDynamicValue {
		...
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(org.eclipse.mdht.uml.fhir.core.dataTypes.String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__DESCRIPTION, oldDescription, description));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getPath() {
		if (path != null && path.eIsProxy()) {
			...
			if (path != oldPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__PATH, oldPath, path));
			}
		}
		return path;
	}
	...
	public void setPath(org.eclipse.mdht.uml.fhir.core.dataTypes.String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__PATH, oldPath, path));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getLanguage() {
		if (language != null && language.eIsProxy()) {
			...
			if (language != oldLanguage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__LANGUAGE, oldLanguage, language));
			}
		}
		return language;
	}
	...
	public void setLanguage(org.eclipse.mdht.uml.fhir.core.dataTypes.String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__LANGUAGE, oldLanguage, language));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.dataTypes.String getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(org.eclipse.mdht.uml.fhir.core.dataTypes.String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__EXPRESSION, oldExpression, expression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__DESCRIPTION:
				if (resolve) return getDescription();
				return basicGetDescription();
			case ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__PATH:
				if (resolve) return getPath();
				return basicGetPath();
			case ResourcesPackage.ACTIVITY_DEFINITION_DYNAMIC_VALUE__LANGUAGE:
