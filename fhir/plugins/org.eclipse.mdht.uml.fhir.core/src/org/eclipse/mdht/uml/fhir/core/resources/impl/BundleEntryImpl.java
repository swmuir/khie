 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.BundleEntryImpl#getLinks <em>Link</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.BundleEntryImpl#getFullUrl <em>Full Url</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.BundleEntryImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.BundleEntryImpl#getSearch <em>Search</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.BundleEntryImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.BundleEntryImpl#getResponse <em>Response</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BundleEntryImpl extends BackboneElementImpl implements BundleEntry {
		...
		if (fullUrl != null && fullUrl.eIsProxy()) {
			...
			if (fullUrl != oldFullUrl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.BUNDLE_ENTRY__FULL_URL, oldFullUrl, fullUrl));
			}
		}
		return fullUrl;
	}
	...
	public void setFullUrl(Uri newFullUrl) {
		...
		fullUrl = newFullUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.BUNDLE_ENTRY__FULL_URL, oldFullUrl, fullUrl));
	}
	...
	public Resource getResource() {
		if (resource != null && resource.eIsProxy()) {
			...
			if (resource != oldResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.BUNDLE_ENTRY__RESOURCE, oldResource, resource));
			}
		}
		return resource;
	}
	...
	public void setResource(Resource newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.BUNDLE_ENTRY__RESOURCE, oldResource, resource));
	}
