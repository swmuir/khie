...
import org.eclipse.mdht.uml.fhir.core.resources.DocumentReferenceContextRelated;
 ...
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getEvents <em>Event</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getFacilityType <em>Facility Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getPracticeSetting <em>Practice Setting</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getSourcePatientInfo <em>Source Patient Info</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resources.impl.DocumentReferenceContextImpl#getRelateds <em>Related</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentReferenceContextImpl extends BackboneElementImpl implements DocumentReferenceContext {
		...
		if (encounter != null && encounter.eIsProxy()) {
			...
			if (encounter != oldEncounter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__ENCOUNTER, oldEncounter, encounter));
			}
		}
		return encounter;
	}
	...
	public void setEncounter(Encounter newEncounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__ENCOUNTER, oldEncounter, encounter));
	}
	...
	public EList<CodeableConcept> getEvents() {
		if (events == null) {
			events = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__EVENT);
		}
		return events;
	}
	...
	public Period getPeriod() {
		if (period != null && period.eIsProxy()) {
			...
			if (period != oldPeriod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__PERIOD, oldPeriod, period));
			}
		}
		return period;
	}
	...
	public void setPeriod(Period newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__PERIOD, oldPeriod, period));
	}
	...
	public CodeableConcept getFacilityType() {
		if (facilityType != null && facilityType.eIsProxy()) {
			...
			if (facilityType != oldFacilityType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__FACILITY_TYPE, oldFacilityType, facilityType));
			}
		}
		return facilityType;
	}
	...
	public void setFacilityType(CodeableConcept newFacilityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__FACILITY_TYPE, oldFacilityType, facilityType));
	}
	...
	public CodeableConcept getPracticeSetting() {
		if (practiceSetting != null && practiceSetting.eIsProxy()) {
			...
			if (practiceSetting != oldPracticeSetting) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__PRACTICE_SETTING, oldPracticeSetting, practiceSetting));
			}
		}
	...
	public void setPracticeSetting(CodeableConcept newPracticeSetting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__PRACTICE_SETTING, oldPracticeSetting, practiceSetting));
	}
	...
	public Patient getSourcePatientInfo() {
		if (sourcePatientInfo != null && sourcePatientInfo.eIsProxy()) {
			...
			if (sourcePatientInfo != oldSourcePatientInfo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__SOURCE_PATIENT_INFO, oldSourcePatientInfo, sourcePatientInfo));
			}
		}
	...
	public void setSourcePatientInfo(Patient newSourcePatientInfo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__SOURCE_PATIENT_INFO, oldSourcePatientInfo, sourcePatientInfo));
	}
	...
	public EList<DocumentReferenceContextRelated> getRelateds() {
		if (relateds == null) {
			relateds = new EObjectContainmentEList<DocumentReferenceContextRelated>(DocumentReferenceContextRelated.class, this, ResourcesPackage.DOCUMENT_REFERENCE_CONTEXT__RELATED);
		}
		return relateds;
	}
